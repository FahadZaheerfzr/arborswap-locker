        ...
        <div className="w-screen h-screen backdrop-blur-md flex flex-col justify-center items-center">
            <div className='max-w-[400px] w-full rounded-[10px] px-5 py-7 bg-white dark:bg-dark-1'>
                ...
                <div className='mt-12 flex items-center justify-between'>
                    <span className='text-gray dark:text-gray-dark text-sm font-medium dark:font-semibold'>
                        Amount
                    </span>
                ...
                <div className='bg-[#F5F1EB] dark:bg-dark-3 mt-2 px-5 py-5'>
                    <div className='flex items-center justify-between'>
                        ...
                        <span className='text-gray dark:text-gray-dark  font-medium text-sm'>
                            ~ $---
                        </span>
                    </div>
                    ...
                    <div className='mt-5 grid grid-cols-4 gap-[10px]'>
                        {options.map((option) => (
                            <div key={option.id} className={`flex items-center justify-center text-sm font-semibold bg-opacity-10 py-2 rounded-sm cursor-pointer
                            ${option.name === "Max" ? "text-primary-green bg-primary-green" : "text-[#C89211] bg-[#C89211]"}`}
            ...
            <div className='max-w-[400px] w-full mt-10'>
                <button className='w-full bg-primary-green text-white py-5 rounded-md font-gilroy font-bold text-xl'
