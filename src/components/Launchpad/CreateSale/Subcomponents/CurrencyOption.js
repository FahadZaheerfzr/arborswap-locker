...
export default function CurrencyOptions({ setCurrency, id, selected, name, icon, symbol }) {
  return (
    <div
      className={`w-full rounded-[10px] px-5 py-3 ${
        ...
        <div className="flex items-center">
          ...
          <div className="flex flex-col ml-2">
            <div className="flex items-center gap-2">
              <span
                className={`font-gilroy text-sm font-bold ${
                  selected ? 'text-dark-text dark:text-light-text' : 'text-dim-text dark:text-dim-text-dark'
                }`}
              >
                {symbol}
              </span>
