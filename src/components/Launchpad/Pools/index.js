              ...
              <div className="flex flex-col">
                <div className="bg-white dark:bg-dark-1 rounded-t-md p-6">
                  ...
                  <div className="flex items-center justify-between mt-8">
                    <span className="text-sm font-medium text-gray dark:text-gray-dark">Soft Cap</span>
                  ...
                  <div className="flex items-center justify-between mt-4">
                    <span className="text-sm font-medium text-gray dark:text-gray-dark">Hard Cap</span>
                  ...
                  <div className="flex items-center justify-between mt-6">
                    <div className="flex flex-col justify-between">
                      <span className="text-xs font-medium text-gray dark:text-gray-dark">Liquidity %</span>
                    ...
                    <div className="flex flex-col justify-between items-center">
                      <span className="text-xs font-medium text-gray dark:text-gray-dark">Lockup Period</span>
